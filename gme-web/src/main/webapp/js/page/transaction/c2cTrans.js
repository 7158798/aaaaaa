...
$("#sellButton").click(function(){
	...
	$.ajax({
		type: "POST",
		url: "http://192.168.136.1:8080/gme-web/api/v1/otc/busBuyAndSell.json", 
...
function showDeity(type){
	$.ajax({
		type: "GET",
		url: "http://192.168.136.1:8080/gme-web/api/v1/otc/deityList.json",
		data: "type=" + type,
		dataType: "json",
		success: function(data){
			if (data.code == 200) {
				...
				$("#deityTable tr:not(:first)").each(function(){
					$(this).children().eq(-3).children().click(function(){
						...
						$.ajax({
							type: "POST",
							url: "http://192.168.136.1:8080/gme-web/api/v1/otc/userBuySell.json",
							dataType: "json",
...
function userOrderQuery(status){
	$.ajax({
		type: "GET",
		url: "http://192.168.136.1:8080/gme-web/api/v1/otc/userOrderHistory.json",
		dataType: "json",
		data: "status=" + status,
		success :function(data) {
			if (data.code == 200) {
				...
				$("#userOrderQuery tr:not(:first)").each(function(){
					...
					$(this).children().eq(-1).children().click(function(){
						$.ajax({
							type: "POST",
							url: "http://192.168.136.1:8080/gme-web/api/v1/otc/userCancleOrder.json",
...
function busOrderList(){
	$.ajax({
		type: "GET",
		url: "http://192.168.136.1:8080/gme-web/api/v1/otc/busOrderList.json",
		data: "symbol=usdt",
		dataType: "json",
		success: function(data){
			if (data.code == 200) {
				...
				$("#busDeityTable tr:not(:first)").each(function(){
					...
					if (cancle != "撤销") {
						...
						$(this).children().eq(-2).children().click(function(){
							$.ajax({
								type: "POST",
								url: "http://192.168.136.1:8080/gme-web/api/v1/otc/busCancleOrder.json",
	...
	function busOrderQuery(){
		...
		$.ajax({
			type: "GET",
			url: "http://192.168.136.1:8080/gme-web/api/v1/otc/busOrderHistory.json",
			dataType: "json",
			data: "symbol=usdt",
			success :function(data) {
				if (data.code == 200) {
...
//										$(this).parent().after("<tr><td>aaaa").next().append("</td><td>bbbbb").append("</td><td>ccc</td></tr>");
	...
	function userPayFinish(event){
		...
		$.ajax({
			type: "POST",
			url: "http://192.168.136.1:8080/gme-web/api/v1/otc/userPayFinish.json",
			dataType: "json",
	...
	function busCheckFinish(event){
		...
		$.ajax({
			type: "POST",
			url: "http://192.168.136.1:8080/gme-web/api/v1/otc/busCheckFinish.json",
			dataType: "json",
			data: "payPassword=" + payPassword + "&orderId=" + orderId,
			success: function(data){
				if (data.code == 200) {
	...
	//我要申诉
	function complaint(){
		window.location.href="http://192.168.136.1:8080/gme-web/myWorkList.html";
	}
